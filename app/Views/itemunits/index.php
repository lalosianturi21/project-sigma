...
<?php foreach (session()->getFlashdata() as $key => $flash) :?>
    ...
    <button class="btn btn-dark button1"><a href="itemunits/new" style="text-decoration: none; color: white">Add item units <i class="fa-solid fa-cart-shopping"></i></a></button>
