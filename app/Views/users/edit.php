...
<input type="hidden" name="_method" value="PUT"/>
    <div class="mb-3">
        ...
        <input type="text" name="name" id="name" class="form-contol" value="<?= $user['name'] ?>">
    ...
    <div class="mb-3">
        ...
        <input type="email" name="email" id="email" class="form-contol" value="<?= $user['email'] ?>">
    ...
    <div class="mb-3">
        ...
        <input type="password" name="password" id="password" class="form-contol" value="<?= $user['password'] ?>">
