<div class="full1">
    <div class="text-dark p-1 text-center shadow-lg fontbg">
        <div class="title1">
        <h1 >Purchases<i class="fa-solid fa-book"></i> </h1>
    </div>
...
<?php foreach (session()->getFlashdata() as $key => $flash) :?>
    ...
    <button class="btn btn-dark button1"><a href="purchases/new" style="text-decoration: none; color: white">Add item <i class="fa-solid fa-cart-shopping"></i></a></button>
