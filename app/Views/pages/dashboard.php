...
<div class="full1">
    <div class="text-dark p-1 text-center shadow-lg fontbg">
        <div class="title1">
        <h1 >Dashboard<i class="fa-sharp fa-solid fa-gauge"></i><div class="float-end me-md-2"></div><br></h1>
    </div>
...
<div class= "container-title">Obat&nbsp;
  <span style="color: #5f9df7">Kapsul</span>
</div>
...
<div class="movie-slide">
<div class= "container-title">Obat&nbsp;
  <span style="color: #f93">Tablet</span>
</div>
...
<section>
  <div class="movie-slide">
<div class= "container-title">Obat&nbsp;
  <span style="color: #ea047e">Sirup</span>
</div>
